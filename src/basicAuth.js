// Taken wholesale from https://github.com/LionC/express-basic-auth
// Then adapted for http/2 without a framework.
    ...
    return function authMiddleware(req, res, next) {
        ...
        function unauthorized() {
            ...
            if (typeof response == 'string')
                return res.writeHead(401).end(response);

            return res.writeHead(401).json(response)
        }
